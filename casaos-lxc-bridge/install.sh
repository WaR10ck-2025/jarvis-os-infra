#!/bin/bash
# install.sh — casaos-lxc-bridge installieren (auf CasaOS-LXC 20)
...
echo "► casaos-lxc-bridge installieren..."
...
# openclaw-net erstellen wenn nicht vorhanden
...
echo ""
echo "  ✓ casaos-lxc-bridge läuft auf http://192.168.10.141:8200"
echo ""
